#!/usr/bin/env python3
"""
Browser Navigation Challenge - Haiku Agent
Haiku tries first, exploit fallback after 2 attempts.
"""
...
def print_summary():
    ...
    print(f"\n{'='*60}")
    print(f"HAIKU AGENT - {metrics['result']} in {dur:.1f}s")
    print(f"{'='*60}")
    print(f"\nSOLVE BREAKDOWN:")
